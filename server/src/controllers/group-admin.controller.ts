...
import { GroupUserCreateAllDto, GroupUserResponseDto } from 'src/dtos/group-user.dto';
import {
  GroupAdminCreateDto,
...
export class GroupAdminController {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  removeUserFromGroup(@Auth() auth: AuthDto, @Param() { id, userId }: UserIdAndIdParamDto) {
