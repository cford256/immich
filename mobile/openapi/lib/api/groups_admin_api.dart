...
class GroupsAdminApi {
  ...
  Future<Response> addUsersToGroupWithHttpInfo(String id, GroupUserCreateAllDto groupUserCreateAllDto,) async {
  ...
  ///
  /// * [GroupUserCreateAllDto] groupUserCreateAllDto (required):
  Future<List<GroupUserResponseDto>?> addUsersToGroup(String id, GroupUserCreateAllDto groupUserCreateAllDto,) async {
    final response = await addUsersToGroupWithHttpInfo(id, groupUserCreateAllDto,);
  ...
  Future<Response> removeUserFromGroupWithHttpInfo(String id, String userId,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [String] userId (required):
  Future<void> removeUserFromGroup(String id, String userId,) async {
    final response = await removeUserFromGroupWithHttpInfo(id, userId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
